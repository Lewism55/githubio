...
const EducationCard: React.FC<EducationCardProps> = ({ educator, subject, grade, dates, info }) => {
    const cardVariants = {
        hover: { scale: 1.1 },
    }
    ...
    return (
        <>
            ...
            <div className='page-description'>
                Below is a summary of my education history, including my degree, A Levels, GCSEs and apprenticeship.
            </div>
